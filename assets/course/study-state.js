...
(function(root){
 ...
 function create(book){
  if(!['shaarei-orah','mystical-qabalah','book-of-thoth','pardes-rimmonim','tanya','etz-chaim','book-t','daat-tevunot','tarot-bohemians','nefesh-hachaim','levi-dogma-ritual'].includes(book))throw Error('Неизвестный модуль.');
