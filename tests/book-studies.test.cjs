...
const books=['shaarei-orah','mystical-qabalah','book-of-thoth','pardes-rimmonim','tanya','etz-chaim','book-t','daat-tevunot','tarot-bohemians','nefesh-hachaim','levi-dogma-ritual','shaarei-kedusha','pictorial-key','derekh-hashem','mathers-tarot'];
...
console.log('Fifteen independent notebooks: JSON round trip, preserved earlier answers, idempotent merge, wrong-book and invalid-lesson rejection passed.');
