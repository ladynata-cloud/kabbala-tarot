...
def build(page,crumbs):
    ...
    b+='<section class="sg-section"><p class="eyebrow">Продолжить · 6 занятий</p><h2>22 пути и Старшие арканы</h2><p>От вопросов десяти позиций переходим к отношениям между сефирот: полный атлас, цепи и развилки, направление и порядок карт.</p><a class="button" href="/course/pathways/">Открыть модуль о путях →</a></section>'
    ...
    for l in D['lessons']:
        ...
        if l['id']==N:b+='<section class="sg-section"><p class="eyebrow">Продолжить · 6 занятий</p><h2>22 пути и Старшие арканы</h2><p>От вопросов десяти позиций переходим к отношениям между сефирот: полный атлас, цепи и развилки, направление и порядок карт.</p><a class="button" href="/course/pathways/">Открыть модуль о путях →</a></section>'
